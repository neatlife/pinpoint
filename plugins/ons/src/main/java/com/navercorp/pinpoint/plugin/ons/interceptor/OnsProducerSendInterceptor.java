...
import com.navercorp.pinpoint.plugin.ons.method.OnsProduceMethod;
...
public class OnsProducerSendInterceptor implements AroundInterceptor {
    private static final OnsProduceMethod PRODUCER_ENTRY_METHOD_DESCRIPTOR;

    static {
        PRODUCER_ENTRY_METHOD_DESCRIPTOR = new OnsProduceMethod();
    }
